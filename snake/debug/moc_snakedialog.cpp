...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_snakedialog_t, stringdata0) + ofs \
...
const QMetaObject snakedialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_snakedialog.data,
...
void *snakedialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_snakedialog.stringdata0))
